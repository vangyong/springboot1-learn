package cn.segema.learn.springboot1.util;
...
public class DateUtil {
	 ...
	 * @param dateOne
	 * @param dateTwo
	 * @return true：dateOne大于dateTwo,false:dateOne小于dateTwo
	 */
	...
	public static Date addHour(Date date) {
		return addInteger(date, Calendar.HOUR_OF_DAY, 8);
	}
	...
	/**
	 * 根据查询类型获取查询开始时间
	 * @param timeScope(24h:最近24小时,7d:最近七天,30d：最近30天)
	 * @return
	 */
	public static Date getStartTime(String timeScope) {
		...
		default:
			if (!StringUtils.isEmpty(timeScope)) {
				int d = Integer.parseInt(timeScope.replace("d", ""));
	...
	/**
	 * 根据时间获取每一间隔时间
	 * @param timeScope(24h:小时,7d/30d：天)
	 * @return
	 */
	public static List<String> getIntevalTime(Date startTime,Date endTime,String timeScope) {
		 List<String> lDate = new ArrayList<String>();
		 
		 if(timeScope.contains("h")) {
